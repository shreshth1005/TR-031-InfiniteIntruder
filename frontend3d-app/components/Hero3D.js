  ...
  return (
    <Float speed={1.2} rotationIntensity={0.4} floatIntensity={0.8}>
      <Sphere args={[1, 64, 64]} position={position} scale={scale}>
        <MeshDistortMaterial color={color} distort={0.15} speed={1} roughness={0.3} />
      </Sphere>
    </Float>
  );
}
...
export default function Hero3D() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-[#0b1120]/20 via-[#0b1120]/40 to-[#0b1120]" />
    </div>
  );
}