...
export default function Home() {
  ...
  return (
    <main className="page-shell min-h-screen text-white relative">
      <Header />

      <section
        id="overview"
        className="relative min-h-[70vh] overflow-hidden px-6 pt-28"
      >
        <div className="absolute inset-0 -z-10" />

        <div className="relative z-20 mx-auto flex min-h-[70vh] max-w-5xl items-center justify-center text-center">
          <div>
      ...
      <section id="workspace" className="relative z-30 mx-auto max-w-7xl px-6 pb-20">
